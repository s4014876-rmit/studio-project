...
public class Database {
	...
	private static void MiscTables() throws IOException {
		...
		INSERT INTO Persona VALUES ('Michael Wiseau', 'resources/images/Michael.png', '<b>Description/Attributes:</b> Michael Is a 45-year-old primary school teacher, who has been teaching students for over 20 years. He is passionate about educating young people and teaching them about the importance of taking care of the planet. He teaches a wide variety of subjects from English to science but finds himself excited to teach the children about the world around them, from the plants and animals in the school yard, to the natural wonders that exist on our planet and even to outer space.<br>
		<b>Needs:</b> Michael needs a tool that can help him easily access and present data about the climate to his students. He is not particularly tech savvy and needs user-friendly and visually engaging experience so that his students can easily understand the information. He also needs reliable and up to date information so that he can be confident in the accuracy of his presentations.<br>
		<b>Goals:</b> Michaels main goal is to find a web app that assists him in teaching his class about climate change in an informative and engaging way. The app will need to present user appropriate surface level information as well as an opportunity to read further into the data so he can have a better understanding before presenting it to his class.<br>
		<b>Skills & experience:</b> Michael has a loose grasp on understanding and navigating computers. However, he recognizes that technology can be a powerful tool for classroom activities and is keen to learn how to integrate technology into his lessons so that his students can have a more interactive and exciting learning experience.');

		INSERT INTO Persona VALUES ('Sophia Maynard', 'resources/images/Sophia.png', '<b>Description:<b> Sophia is a 1st year university student studying environmental science and like many other young people, is concerned about the environment. Sophia is particularly interested in keeping up with climate related news, attends local demonstrations and protests, and often talks about it with other people. She is even currently working on a project for one of her classes where she will develop her analytical and research skills so that she can have an informed opinion and a better chance of working towards a positive impact on the climate in the future.<br>
		<b>Needs:<b> Sophia needs an accessible but comprehensive data resource to build on her knowledge and add substance and validity to her presentation. She needs credible and reliable information so she can make justified and accurate points to talk about in her project while not being overwhelmed with excessive detail of data or spending lots of time learning how to use the platform.<br>
		<b>Goals:<b> Sophia wants to do well on her assessment while also gaining a basic understanding of data analysis and a broad view of world temperature trends and its relevance to the climate crisis. This way she will enrich her own understanding, and then be able to enrich the understanding of other people by explaining the effects of climate change in a concrete way.<br>
		<b>Skills & Experience:<b> Sophia has basic computer literacy and is familiar with simple data concepts to where she can consider some ways which to get meaning from data. She is generally familiar with climate concepts.');

		INSERT INTO Persona VALUES ('Sarah Moore', 'resources/images/Sarah.png', '<b>Description:<b> Sarah is an environmental scientist working with a team of data analysts for the state to outline strategies for Victoria to use to combat their own environmental impact. She has a doctorate in climate change, so she has an advanced understanding of climate data. She believes that climate change is the most vital issue of the 21st century and is deeply committed to finding solutions for global climate issues.<br>
		<b>Needs:<b> Sarah needs a digital platform which will let her utilize nuanced and high-quality climate data without needing to go through the regular boilerplate of setting up software and document files on her computer. She also needs to be able to reference this data and allow her colleagues to access the same site and collect their own data so they can have discussions about their individual findings. She requires data outlining trends from different countries to show state officials what countries and states are doing to combat climate change and how effective it has been so far. So highly adjustable and filtered information needs to be easily accessed and referenced for her presentations.<br>
		<b>Goals:<b>Sarah’s goal is to identify whether certain countries actions on the climate crisis is having a positive effect o so that she can propose justified and proved strategies to the state on how to address this issue at a state level. Providing data and calculated values on trending and correlated statistics for the purpose of validating or voiding current strategies.<br>
		<b>Skills and experience:<b>Sarah has published her own research about climate change published before, so she is adept at understanding data about the climate and its implications. She is comfortable with using a computer, as she does so regularly in her job');
		""");
	}
